...
namespace ProjectX.Controllers
{
    public class ChatController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SendMessage(ChatMessageViewModel message, int chatRoomId)
        {
            ...
            await _chatService.SendMessageAsync(message, chatRoomId, senderId);

            // Redirect to the chat room view
            return RedirectToAction(nameof(Index), new { salonId = chatRoomId });
        }
